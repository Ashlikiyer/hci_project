  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = {
        ...
        "skills-section-4": document.getElementById("skills-section-4"), // Fixed typo here
  ...
  const team = [
    {
      ...
      skills: [
        { icon: <FaPaintBrush size={40} />, title: "Graphic Designing", description: "Creating stunning visual designs." },
        { icon: <FaCode size={40} />, title: "Web Development", description: "Building responsive websites." },
        { icon: <FaInstagram size={40} />, title: "Social Media", description: "Managing online presence." },
      ],
    },
    {
      ...
      skills: [
        ...
        { icon: <FaLaptopCode size={40} />, title: "Prototyping", description: "Building interactive mockups." },
      ],
    },
    {
      name: "Angelo F. Gopez",
      ...
      skills: [
        ...
        { icon: <FaDatabase size={40} />, title: "Databases", description: "Optimizing data storage." },
      ],
    },
    {
      ...
      skills: [
        ...
        { icon: <FaPenNib size={40} />, title: "Content Strategy", description: "Crafting engaging content." },
      ],
    },
    {
      name: "Liam Patel",
      ...
      description1: "Creative illustrator and animator. Brings ideas to life with stunning visuals and dynamic motion graphics.",
      description2: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      skills: [
        { icon: <FaPalette size={40} />, title: "Illustration", description: "Creating unique artwork." },
        { icon: <FaPaintBrush size={40} />, title: "Animation", description: "Designing motion graphics." },
        { icon: <FaLaptopCode size={40} />, title: "Digital Art", description: "Mastering design tools." },
      ],
    },
    {
      name: "Olivia Grant",
      ...
      description1: "Data analyst with expertise in turning numbers into actionable insights. Passionate about data-driven decision making.",
      description2: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      skills: [
        { icon: <FaDatabase size={40} />, title: "Data Analysis", description: "Interpreting complex data." },
        { icon: <FaChartLine size={40} />, title: "Visualization", description: "Creating clear charts." },
        { icon: <FaCode size={40} />, title: "Programming", description: "Writing analytical scripts." },
      ],
    },
  ];
          ...
          <div key={index} className="my-16 mx-4">
            ...
            <div
              ...
              className={`transition-opacity duration-1000 ease-in-out mb-10 ${
                isVisible[`about-section-${index + 1}`] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              <div className={`max-w-5xl mx-auto flex items-center justify-center p-10 ${member.bgGradient} rounded-xl shadow-lg`}>
                ...
                <div className="w-2/3 p-6">
                  <h2 className={`text-4xl font-bold ${member.titleColor} mb-4`}>{member.name}</h2>
                  <p className="text-gray-300 text-lg">{member.description1}</p>
                  <p className="text-gray-300 text-lg mt-4">{member.description2}</p>
                </div>
              </div>
            </div>

            {/* Skills Section */}
            <div className={`${member.bgGradient} text-white py-16 rounded-xl shadow-lg`}>
              <h2 className={`text-4xl font-bold text-center ${member.titleColor} mb-6`}>Skills</h2>
              <div className={`w-20 h-1 ${member.titleColor.replace("text-", "bg-")} mx-auto mb-10`}></div>
              ...
              <div
                ...
                className={`max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-6 transition-opacity duration-1000 ease-in-out ${
                  isVisible[`skills-section-${index + 1}`] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                }`}
              >
                {member.skills.map((skill, skillIndex) => (
                  <div
                    key={skillIndex}
                    className={`border ${member.titleColor.replace("text-", "border-")} p-8 rounded-lg text-center hover:${member.titleColor.replace("text-", "bg-")} hover:text-black transition duration-300`}
                  >
                    <div className={`${member.titleColor} text-5xl mb-4`}>{skill.icon}</div>
